...
const xApiKey = 'Sw2YO3HEAiNUHQct' //Enter Your x-api-key here
const Create = () => {
          ...
          <div
            ...
            <form>
              <div className='img-container text-center mt-5'>
                ...
                <button className='btn btn-primary button-24 text-light rounded-pill m-2'>Select File</button>
                <br></br>
                <input
                  type='file'
                  style={{
              ...
              <div className='fields'>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className='px-5 pt-4'>
                        <select name='network' className='form-select' onChange={(e) => setnetwork(e.target.value)}>
                ...
                <div className='p-5 text-center'>
                  <button type='submit' className='btn btn-success button-25' onClick={mintNow}>
                    Submit
                  </button>
                </div>
              </div>
            ...
            <div className='text-center'>
              This creates one of kind NFTs by setting the <code>max_supply</code> parameter to 0. But you can update it
